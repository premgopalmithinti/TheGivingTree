...
<ul>
	...
	<form action="addnewvolunteer" method="post" modelAttribute="von">
    ...
    <input name ="password" type = "password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required></input>
    <p class="lable">Mail Id</p>
    <input name ="mail" required="required"></input>
   
    <p class="lable">Phone</p>
    <input name = "phone" required="required"></input>
    <br>
