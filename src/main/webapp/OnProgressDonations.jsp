...
<tr border= 1>
	...
	<td>
		...
		<br>
		<form action="updateStatusonpr" method="post" modelAttribute="donn">
	        ...
	        <select name ="assignedvolunteer">
	            <option value="${don.assignedvolunteer}">${don.assignedvolunteer}</option>
	           <c:forEach items ="${vonlist}" var ="von">
	            <option value="${von.username}">${von.username}</option>
	            </c:forEach>
	        </select>
