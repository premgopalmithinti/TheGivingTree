...
<div class = "ratingdashboard">

<div class = "donationrating">
<h1><c:out value ="${dopavg}"></c:out>/5</h1>
<p>donation process</p>
</div>

<div class = "donationrating">
<h1><c:out value ="${donavg}"></c:out>/5</h1>
<p>overall experience</p>
</div>

<div class = "donationrating">
<h1><c:out value ="${volavg}"></c:out>/5</h1>
<p>volunteer pickup</p>
</div>
</div>
