...
<a class = "vbutton" href ="/newVolunteer">Volunteer +</a> </br>
...
<c:forEach items ="${volistt}" var ="don">
<tr>
<td><c:out value ="${don.fullname}"></c:out></td>
<td><c:out value ="${don.gender}"></c:out></td>
<td><c:out value ="${don.username}"></c:out></td>
<td><c:out value ="${don.password}"></c:out></td>
<td><c:out value ="${don.mail}"></c:out></td>
<td><c:out value ="${don.phone}"></c:out></td>
<td><c:out value ="${don.city}"></c:out></td>
